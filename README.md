...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-apctzui.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-apctzui.containers.anotherwebservice.com/
...
```
git clone git@github.com:adesh-sri/container-apctzui.git
cd container-apctzui
```
...
```
docker attach container-apctzui
```
